...
from post_covernet import PostCoverNet, UCELoss, ConstantLatticeLoss
...
class PredictionModel(pl.LightningModule):
    ...
    def forward(self, x, return_output='alpha'):
        ...
        logits = self.postcovernet(image_tensor, agent_state_vector, return_output=return_output)
        return logits
    ...
    def training_step(self, batch, batch_idx):
        ...
        logits = self.postcovernet(image_tensor, agent_state_vector)
